...
#define STRING_CONFIG_H_AUTHOR "(Matthew Yates, SKR-mini-E3-V3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nanodroplet Printer"
...
#define DUMMY_THERMISTOR_998_VALUE  85
#define DUMMY_THERMISTOR_999_VALUE 240
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 792, 793, 793, 4704 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 5, 5, 5, 0.7 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 10, 10, 10, 1 } // ...or, set your own edit limits
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 200, 200, 200, 200 } // ...or, set your own edit limits
#endif
...
//#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 0.6, 0.6, 0.6, 0.6 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -15, -4.25 }
...
#define XY_AFTER_HOMING { 100, 100 }  // (mm) Move to an XY position after homing (and raising Z)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE  10   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
