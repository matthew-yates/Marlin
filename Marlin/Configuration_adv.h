...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN       255 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 20*60, 20*60, 20*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X2_CURRENT_HOME X_CURRENT
    #define X2_MICROSTEPS   X_MICROSTEPS
    ...
    #define Y2_CURRENT_HOME Y_CURRENT
    #define Y2_MICROSTEPS   Y_MICROSTEPS
    ...
    #define Z2_CURRENT_HOME Z_CURRENT
    #define Z2_MICROSTEPS   Z_MICROSTEPS
    ...
    #define Z3_CURRENT_HOME Z_CURRENT
    #define Z3_MICROSTEPS   Z_MICROSTEPS
    ...
    #define Z4_CURRENT_HOME Z_CURRENT
    #define Z4_MICROSTEPS   Z_MICROSTEPS
